...
function buddyforms_moderation_post_edit_meta_box_actions(){
        ...
        jQuery(document).ready(function (){
            jQuery(document).on( "click", '#buddyforms_reject_now', function( evt ) {
                ...
                jQuery.ajax({
                    type: 'POST',
                    url: ajaxurl,
                    data: {"action": "buddyforms_reject_now", "post_id": post_id, "user_email": user_email, "bf_reject_mail_from": bf_reject_mail_from, "bf_reject_mail_subject": bf_reject_mail_subject, "bf_reject_mail_message": bf_reject_mail_message},
    ...
    <div id="buddyforms_reject_modal" style="display:none;">
        <div id="buddyforms_reject_wrap">
            ...
            <p>Message will be sent to the Author <?php echo get_the_author_meta( 'user_nicename', $post->post_author ); ?> to the mail address <?php echo get_the_author_meta( 'user_email', $post->post_author ); ?></p>

            <table class="form-table">
                <tbody>
                <tr>
                    <th><label for="bf_reject_mail_from">Mail From</label></th>
                    <td><input id="bf_reject_mail_from" type="text" value="<?php  echo get_bloginfo( 'admin_email' ); ?>"></td>
                </tr>
                <tr>
